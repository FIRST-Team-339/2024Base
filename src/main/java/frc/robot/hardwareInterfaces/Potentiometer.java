...
public class Potentiometer extends AnalogInput
     ...
     * ------------------------------------------------------
     *
     * @description this denotes whether or not the pot is keeping values
     *              reversed (backwards)
     * @author Bob Brown
     * @written Feb 19, 2011
     *          --------------------------------------------------------
    ...
    public int get()
    {
        ...
        if (this.isReversed == false)
            ...
            if (this.getPrintToScreen() == true)
                System.out.println("Pot - Normalized value: " + retValue);
            return (retValue);
            }
        // ---------------------------------
    ...
    public double get(double range)
    {
        ...
        double retVal = (((2 * this.get()) - this.maxDegreesForPotentiometer)
                / this.maxDegreesForPotentiometer) * (range / 2);
        if (this.isReversed == false)
            {
            // ---------------------------------
            // if we requested to print out the Normalized
    ...
    public double getFromRange()
    {
        ...
        double retVal = (((2 * this.get()) - this.getMaxDegrees())
                / this.getMaxDegrees()) * (this.getMaxDegrees() / 2);
        if (this.isReversed == false)
            {
            // ---------------------------------
            // if we requested to print out the Normalized
