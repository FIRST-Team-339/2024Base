package frc.robot.hardwareInterfaces.drive;

import frc.robot.hardwareInterfaces.KilroyEncoder;
import frc.robot.hardwareInterfaces.Transmission.oldTankTransmission;
import frc.robot.hardwareInterfaces.Transmission.oldTankTransmission.Motors;
...
public class oldDrive
     ...
     */
    public oldDrive(oldTankTransmission transmission, KilroyEncoder leftEncoder,
     ...
     */
    public oldDrive(oldTankTransmission transmission,
    ...
    public void drive(double leftVal, double rightVal)
    {
        ...
        if (transmission instanceof oldTankTransmission)
            ((oldTankTransmission) transmission).drive(leftVal, rightVal);
    } // end drive() - overloaded
     ...
     */
    public oldTankTransmission getTransmission()
    {
    ...
    private final oldTankTransmission transmission;
